...
export default function Register() {
  ...
  return (
    <div className="max-w-md mx-auto px-4 py-12">
      ...
      <p className="text-gray-600 mb-8">注册即享新人福利，学习课程、报名赛事、分享赚钱</p>
        ...
        <div>
          ...
          <div className="flex gap-2">
            <input
              ...
              placeholder="请输入验证码"
              className="flex-1 rounded-lg border border-gray-300 px-4 py-2 focus:border-primary focus:ring-1 focus:ring-primary"
            />
