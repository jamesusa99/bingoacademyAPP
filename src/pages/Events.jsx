...
const CORE_SERVICES = [
  ...
  { icon: '🧠', title: 'AI能力测评', desc: '测评成绩可纳入评审参考', to: '/events/ai-test', hot: false },
      ...
      <section className="mb-10">
        <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-bingo-dark via-slate-800 to-cyan-900 text-white p-8 sm:p-12">
          <div className="max-w-2xl relative z-10">
            <div className="text-xs font-medium text-cyan-300 mb-2 tracking-wider">赛事服务中心 · 全流程赛事生态平台</div>
            <h1 className="text-2xl sm:text-4xl font-bold leading-tight mb-4">让每一场赛事<br />都成为成长的里程碑</h1>
            <p className="text-slate-300 text-sm mb-6">报名参赛 · 备赛集训 · 主办定制 · AI测评 · 白名单对接 · 成果展示，赛事全链路一站式服务</p>
            <div className="flex flex-wrap gap-3">
              <button onClick={() => setShowForm(true)} className="bg-primary hover:bg-cyan-600 text-white px-6 py-2.5 rounded-xl text-sm font-medium transition">我要办赛</button>
              <Link to="/events/whitelist" className="bg-white/10 hover:bg-white/20 text-white px-6 py-2.5 rounded-xl text-sm font-medium transition">白名单赛事咨询</Link>
              <Link to="/events/ai-test" className="bg-white/10 hover:bg-white/20 text-white px-6 py-2.5 rounded-xl text-sm font-medium transition">AI能力测评</Link>
            </div>
          </div>
        ...
        <div className="card p-8 bg-gradient-to-r from-slate-800 to-cyan-900 text-white rounded-2xl">
          <div className="flex flex-wrap items-center justify-between gap-6">
            <div className="max-w-lg">
              ...
              <p className="text-slate-300 text-sm mb-4">政企科创赛、院校教学赛、商会公益赛三大定制模板一键套用，支持AI课程联动、AI能力测评嵌入、白名单赛事对接，专人2小时响应需求。</p>
