      ...
      <section className="mb-10">
        <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-bingo-dark via-slate-800 to-indigo-900 text-white p-8 sm:p-12">
          <div className="relative z-10 max-w-2xl">
            <p className="text-xs text-indigo-300 mb-2 tracking-wider">Bingo Academy · 数智职业板块</p>
            <h1 className="text-3xl sm:text-4xl font-bold leading-tight mb-3">AI数智赋能 · 职业未来可期</h1>
            <p className="text-slate-300 text-sm mb-1">数智技能学习 · 职业教材配套 · 产教实训对接 · 就业资源匹配 · 内容创作变现 · 合作资源联动</p>
            ...
            <div className="flex flex-wrap gap-3">
              <button onClick={() => setSection('jobs')} className="bg-primary hover:bg-cyan-500 text-white px-6 py-2.5 rounded-xl text-sm font-medium transition">查看数智岗位</button>
