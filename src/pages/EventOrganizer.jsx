...
const PACKAGES = [
  ...
  },
  {
    ...
    price: '联系咨询',
    badge: '推荐',
    items: ['专业套餐全部功能', '缤果AI学院课程联动', 'AI能力测评嵌入', '白名单赛事申报对接', '证书/奖品全托管', '全程运营专员驻场'],
    ai: true,
  },
]
...
const CAPABILITIES = [
  ...
  { icon: '🧠', name: 'AI能力测评', desc: '测评成绩可纳入初赛参考，强化赛事含金量', isNew: true },
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-4">
                  {[
                    ...
                    { key: 'needTest', label: 'AI能力测评嵌入', icon: '🧠' },
      ...
      <section className="mb-10">
        ...
        <div className="space-y-3">
          {[
            ...
            { q: 'AI能力测评是否会影响参赛选手的参赛资格？', a: '默认为选做项，主办方可配置测评成绩是否纳入初赛参考（如占比10%），不强制影响参赛资格。' },
