    ...
    <div>
      ...
      <section className="bg-gradient-to-br from-bingo-dark via-slate-800 to-primary/80 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
          <p className="text-xs text-cyan-300 mb-3 tracking-widest font-medium">缤纷成果 · 真实见证</p>
          <h1 className="text-2xl sm:text-4xl font-bold mb-2">
            用实力破解<span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-300 to-amber-300">AI教育焦虑</span>
          </h1>
          <p className="text-slate-300 text-sm mb-6">千名学员成长见证 | 百所合作机构赋能 | 全赛道赛事获奖认证</p>
